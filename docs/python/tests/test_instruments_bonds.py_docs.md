# Documentation: test_instruments_bonds.py

## File Metadata
- **Path:** `python/tests/test_instruments_bonds.py`
- **Size:** 129,649 bytes
- **Lines:** 3,540
- **Words:** 11,256
- **Extension:** `.py`
...
- `_my_acc()`
- `test_custom_function_affects_ytm()`
- `_my_acc()`
- `test_custom_ytm_disc_funcs()`
- `_my_acc()`
- `_v()`
- `test_metric_ytm_no_fx()`
- `test_accrued_in_text()`
- `test_ex_div()`
- `test_fixed_rate_bond_price_ukg()`
- `test_fixed_rate_bond_price_ukg_back_stub()`
- `test_fixed_rate_bond_yield_ukg()`
- `test_fixed_rate_bond_accrual()`
- `test_fixed_rate_bond_stub_ytm()`
- `test_fixed_rate_bond_price_ust()`
- `test_ust_price_street()`
- `test_long_stub_first_cashflow()`
- ... and 138 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.668590
