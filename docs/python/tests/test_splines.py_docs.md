...
- `t()`
- `x()`
- `test_individual_bsplines()`
- `test_first_derivative_endpoint_support()`
- `test_second_derivative_endpoint_support()`
- `test_third_derivative_endpoint_support()`
- `test_fourth_derivative_endpoint_support()`
- `test_ppdnev()`
- `test_ppev()`
- `test_csolve()`
- `test_csolve_lsq()`
- `test_csolve_raises()`
- `test_copy()`
- `test_spline_equality_type()`
- `test_dual_AD()`
- `test_dual2_AD()`
- `test_dual_AD_raises()`
- `test_dual2_AD_raises()`
- `test_dual_float_raises()`
- `test_bsplmatrix()`
- ... and 3 more
