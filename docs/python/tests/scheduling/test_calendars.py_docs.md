# Documentation: test_calendars.py
...
- `cal_()`
- `test_is_non_bus_day()`
- `test_is_non_bus_day_raises()`
- `test_cal_no_hols()`
- `test_named_cal()`
- `test_multiple_named_cal()`
- `test_add_tenor_raises()`
- `test_add_tenor()`
- `test_add_negative_tenor()`
- `test_add_tenor_special_cases()`
- `test_adjust_date()`
- `test_adjust_date_cal()`
- `test_adjust_date_raises()`
- `test_modifiers_som()`
- `test_modifiers_eom()`
- `test_dcf()`
- `test_dcf_special()`
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.658590
