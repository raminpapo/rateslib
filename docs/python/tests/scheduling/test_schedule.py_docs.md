...
- `cal_()`
- `test_is_divisible_months()`
- `test_get_unspecified_roll()`
- `test_infer_stub_date()`
- `test_infer_stub_date_no_inference_on_regular()`
- `test_infer_stub_date_no_inference_on_regular_dual()`
- `test_infer_stub_date_invalid_roll()`
- `test_infer_stub_date_dual_sided()`
- `test_infer_stub_date_dual_sided2()`
- `test_infer_stub_date_dual_sided_invalid()`
- `test_infer_stub_date_eom()`
- `test_repr()`
- `test_schedule_str()`
- `test_schedule_raises()`
- `test_unadjusted_regular_swap_dead_stubs()`
- `test_unadjusted_regular_swap()`
- `test_check_regular_swap_mf()`
- `test_generate_irregular_uschedule()`
- `test_generate_regular_uschedule()`
- `test_regular_n_periods()`
- ... and 20 more
