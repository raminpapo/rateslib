...
- `test_curvemeta_json_round_trip()`
- `test_curvespline_json_round_trip()`
- `test_curveinterpolator_json_round_trip()`
- `test_no_input_round_trip()`
- `curve()`
- `line_curve()`
- `index_curve()`
- `test_serialization()`
...
- `test_serialization_curve_str_calendar()`
- `test_serialization_curve_custom_calendar()`
