# Documentation: test_fx_volatility.py
...
**Functions defined:** 86
- `fxfo()`
- `test_get_from_strike()`
- `test_get_from_strike_ad()`
- `test_get_from_strike_ad_2()`
- `test_get_from_unsimilar_delta()`
- `test_get_from_similar_delta()`
- `test_get_from_similar_delta_pa()`
- `test_get_from_unsimilar_delta2()`
- `test_set_same_ad_order()`
- `test_set_ad_order_raises()`
- `test_iter_raises()`
- `test_update_node()`
- `test_delta_index_range_for_spot()`
- `test_update_csolve()`
- `test_flat_smile_with_zero_delta_index_input()`
- `test_expiry_before_eval()`
- `test_smile_0_no_interp()`
- `test_smile_end_no_interp()`
- `test_smile_tot_var_lin_interp()`
- `test_smile_from_exact_expiry()`
- ... and 66 more
