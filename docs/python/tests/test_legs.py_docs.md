# Documentation: test_legs.py

## File Metadata
- **Path:** `python/tests/test_legs.py`
- **Size:** 82,482 bytes
- **Lines:** 2,464
- **Words:** 6,169
- **Extension:** `.py`
...
- `TestIndexFixedLegExchange`
- `TestIndexFixedLeg`
- `TestFloatLegExchangeMtm`
- `TestCustomLeg`

**Functions defined:** 109
- `curve()`
- `hazard_curve()`
- `test_repr()`
- `test_repr_index()`
- `test_repr_mtm()`
- `test_repr_custom()`
- `test_float_leg_analytic_delta_with_npv()`
- `test_float_leg_analytic_delta()`
- `test_float_leg_cashflows()`
- `test_float_leg_npv()`
- `test_float_leg_fixings()`
- `test_float_leg_fixings_series()`
- `test_float_leg_fixings_scalar()`
- `test_float_leg_rfr_fixings_table()`
- `test_rfr_with_fixings_fixings_table_issue()`
- `test_float_leg_set_float_spread()`
- `test_is_linear()`
- `test_float_leg_spread_calculation()`
- `test_fixing_method_raises()`
- `test_leg_periods_unadj_dates()`
- ... and 89 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.669590
