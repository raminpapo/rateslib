...
**Functions defined:** 92
- `test_method_state_chg()`
- `test_method_does_not_chg_state()`
- `test_cached_property_fxarray()`
- `test_fxforwards_cache_clearing()`
- `test_ill_constrained()`
- `test_avoid_recursion_error()`
- `test_rates()`
- `test_fxrates_multi_single_currency()`
- `test_fxrates_multi_chain()`
- `test_fxrates_pickle()`
- `test_rates_repr()`
- `test_fx_update_blank()`
- `test_convert_and_base()`
- `test_convert_none()`
- `test_convert_warn()`
- `test_convert_error()`
- `test_positions_value()`
- `test_fxrates_set_order()`
- `test_update_raises()`
- `test_restate()`
- ... and 72 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.664590
