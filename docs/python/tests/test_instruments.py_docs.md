# Documentation: test_instruments.py

## File Metadata
- **Path:** `python/tests/test_instruments.py`
- **Size:** 234,370 bytes
- **Lines:** 6,705
- **Words:** 19,442
- **Extension:** `.py`
...
- `TestNDF`
- `TestNonMtmXCS`
- `TestNonMtmFixedFloatXCS`
- `TestNonMtmFixedFixedXCS`
- `TestCDS`
- `TestXCS`
- `TestFixedFloatXCS`
- `TestFixedFixedXCS`
...
- `usdeur()`
- `simple_solver()`
- `test_instrument_repr()`
- `test_get_curve_from_solver()`
- `test_get_curves_and_fx_from_solver()`
- `test_get_curves_fx_and_base_maybe_from_solver_object_types()`
- `test_get_curves_and_fx_from_solver_raises()`
- `test_get_curves_from_solver_multiply()`
- `test_get_proxy_curve_from_solver()`
- `test_ambiguous_curve_in_out_id_solver_raises()`
- `test_get_multicsa_curve_from_solver()`
- `setup_class()`
- `teardown_class()`
- `test_base_and_fx()`
- `test_base_and_solverfx()`
- `test_base_and_fx_and_solverfx()`
- ... and 256 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.667590
