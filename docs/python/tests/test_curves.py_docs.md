# Documentation: test_curves.py

## File Metadata
- **Path:** `python/tests/test_curves.py`
- **Size:** 98,364 bytes
- **Lines:** 2,877
- **Words:** 9,886
- **Extension:** `.py`
...
- `TestIndexValue`
- `TestCurveSpline`
- `Test_CreditImpliedCurve`
- `TestMeta`

**Functions defined:** 161
- `curve()`
- `line_curve()`
- `index_curve()`
- `test_flat_interp()`
- `test_linear_interp()`
- `test_log_linear_interp()`
- `test_linear_zero_rate_interp()`
- `test_line_curve_rate()`
- `test_curve_rate_floating_spread()`
- `test_curve_rate_raises()`
- `test_index_left()`
- `test_zero_rate_plot()`
- `test_curve_equality_type_differ()`
- `test_copy_curve()`
- `test_curve_equality_checks()`
- `test_curve_equality_spline_coeffs()`
- `test_curve_interp_raises()`
- `test_curve_sorted_nodes_raises()`
- `test_curve_interp_case()`
- `test_custom_interpolator()`
- ... and 141 more
