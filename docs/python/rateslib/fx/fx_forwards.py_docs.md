...
- `_validate_state()`
- `_validate_fx_curves()`
- `_calculate_immediate_rates()`
- `_calculate_immediate_rates_same_settlement_frame()`
- `__repr__()`
- `_get_curves_for_currencies()`
- `rate()`
- `_rate_without_validation()`
- `_rate_direct()`
- `positions()`
- `convert()`
- `convert_positions()`
