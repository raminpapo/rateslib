# Documentation: delta_vol.py

## File Metadata
- **Path:** `python/rateslib/fx_volatility/delta_vol.py`
- **Size:** 48,349 bytes
- **Lines:** 1,285
- **Words:** 5,122
- **Extension:** `.py`
...
> Create an *FX Volatility Smile* at a given expiry indexed by delta percent.
    ...
    eval_date: datetime
        Acts as the initial node of a *Curve*. Should be assigned today's immediate date.
    expiry: datetime
        The expiry date of the options associated
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.630590
