...
- `grad_v_v_rT()`
- `grad_s_vT()`
- `_grad_s_vT_final_iteration_dual()`
- `_grad_s_vT_final_iteration_analytical()`
- `_grad_s_vT_fixed_point_iteration()`
- `grad_s_s_vT()`
- `_grad_s_s_vT_fwd_difference_method()`
- `_grad_s_s_vT_final_iteration_analytical()`
- `grad_f_rT_pre()`
- `J2_pre()`
- `grad_f_v_rT_pre()`
- `grad_f_f_rT_pre()`
