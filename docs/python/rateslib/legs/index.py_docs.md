# Documentation: index.py

## File Metadata
- **Path:** `python/rateslib/legs/index.py`
- **Size:** 18,387 bytes
- **Lines:** 481
- **Words:** 1,651
- **Extension:** `.py`
...
- `index_base()`
- `_regular_period()`
- `_validate_index_fixings_as_series()`
- `__init__()`
- `_regular_period()`
- `_set_periods()`
- `cashflow()`
...
- `npv()`
- `__init__()`
- `_set_exchange_periods()`
- `_set_interim_exchange_periods()`
- `_set_regular_periods()`
- `_set_periods()`
- `npv()`
- `cashflows()`
- ... and 1 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.645590
