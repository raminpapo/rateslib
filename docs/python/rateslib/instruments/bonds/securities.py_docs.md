# Documentation: securities.py

## File Metadata
- **Path:** `python/rateslib/instruments/bonds/securities.py`
- **Size:** 113,186 bytes
- **Lines:** 2,957
- **Words:** 11,029
- **Extension:** `.py`
...
- `_period_cashflow()`
- `_accrued_fraction()`
- `_set_base_index_if_none()`
- `ex_div()`
- `_accrued()`
- `_ytm()`
- `s()`
- `_price_from_ytm()`
- `_generic_price_from_ytm()`
- `fwd_from_repo()`
- `repo_from_fwd()`
- `_npv_local()`
- `npv()`
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.636590
