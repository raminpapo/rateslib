...
- `_v2_()`
- `_v2_annual()`
- `_v2_annual_pay_adjust()`
- `_v1_compounded()`
- `_v1_simple()`
- `_v1_simple_pay_adjust()`
- `_v1_compounded_pay_adjust()`
- `_v1_compounded_final_simple()`
- `_v1_compounded_final_simple_pay_adjust()`
- `_v1_comp_stub_act365f()`
- `_v1_simple_long_stub()`
- `_v3_compounded()`
- `_v3_compounded_pay_adjust()`
- `_v3_30e360_u_simple()`
- `_v3_simple()`
- `_v3_simple_pay_adjust()`
- `_c_from_obj()`
- ... and 2 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.634590
