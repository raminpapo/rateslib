# Documentation: multi_currency.py

## File Metadata
- **Path:** `python/rateslib/instruments/rates/multi_currency.py`
- **Size:** 63,548 bytes
- **Lines:** 1,640
- **Words:** 6,211
- **Extension:** `.py`
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.642590
