# Documentation: vanilla.py

## File Metadata
- **Path:** `python/rateslib/instruments/fx_volatility/vanilla.py`
- **Size:** 31,779 bytes
- **Lines:** 823
- **Words:** 2,816
- **Extension:** `.py`
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.639590
