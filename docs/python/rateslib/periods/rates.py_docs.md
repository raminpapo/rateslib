# Documentation: rates.py

## File Metadata
- **Path:** `python/rateslib/periods/rates.py`
- **Size:** 79,028 bytes
- **Lines:** 1,949
- **Words:** 7,625
- **Extension:** `.py`
...
- `npv()`
- `cashflow()`
- `_maybe_get_cal_and_conv_from_curve()`
- `rate()`
- `_rate_ibor()`
- `_rate_ibor_from_df_curve()`
- `_rate_ibor_from_line_curve()`
- `_rate_ibor_interpolated_ibor_from_dict()`
- `_rate()`
- `_rate_rfr()`
- `_rate_rfr_from_df_curve()`
- `_rate_rfr_from_line_curve()`
- ... and 21 more
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.650590
