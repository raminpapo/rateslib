# Documentation: fx_volatility.py
...
> Abstract base class for constructing volatility components of FXOptions.
    ...
    expiry: datetime
        The expiry of the option: when the fixing and moneyness is determined.
    delivery: datetime
        The delivery date of the underlying FX pair. E.g. typically this would be **spot*
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.649590
