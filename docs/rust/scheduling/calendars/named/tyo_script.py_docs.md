...
**Functions defined:** 4
- `sunday_to_monday_or_tuesday()`
- `sunday_to_monday_or_tuesday_or_wednesday()`
- `vernal_equinox_sun_to_mon()`
- `autumn_equinox_sun_to_mon()`
...
## Usage Notes
- Last modified: 2025-11-18T07:49:28.701591
